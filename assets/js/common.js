...
function inputLoad(opt){
    ...
    $("#"+ o.objId).upload('upload',{
        actionUrl:'../com/ajax!uploadFile.action;jsessionid='+o.jsessionid,
        entityName: o.entityName,
        multi:true
    });
}
...
function multiDuty(pdata){
    ajax_action("../com/ajax-dialog!dutyDlg.action",pdata,{},function(pdata){
